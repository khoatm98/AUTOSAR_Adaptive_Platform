...
RENESASOTA_IMPORT = "github.com/khoatm98/demo-soafee-rcar-s4"
...
SRCREV_renesasota = "7fe8b15a0a265b3cc1d5164bfa2020484533d640"
...
do_prepare_modules_append() {
    ...
    echo 'import _ "${RENESASOTA_IMPORT}/updatemodules/renesasrefappota"' >> ${file}
    echo 'import _ "${RENESASOTA_IMPORT}/updatemodules/renesasrefappota_domd"' >> ${file}
}
