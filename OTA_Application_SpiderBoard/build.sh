...
if [ -d ./yocto -a ! -h ./yocto ]
then
   echo "./yocto found, skip cloning step..."
else
   mkdir -p ./yocto
...
cp -rf ./../aos_local_patch/aos-updatemanager ./yocto/meta-aos-rcar-gen4/meta-aos-rcar-gen4-domd/recipes-aos

# Apply patch for aos-update
rm -rf ./yocto/meta-aos-rcar-gen4/meta-aos-rcar-gen4-dom0/recipes-core/aos-update
cp -rf ./../aos_local_patch/aos-update ./yocto/meta-aos-rcar-gen4/meta-aos-rcar-gen4-dom0/recipes-core
